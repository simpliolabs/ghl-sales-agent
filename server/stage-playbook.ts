...
const PLAYBOOKS: Record<string, StagePlaybook> = {
  ...
  "Quote Sent": {
    ...
    preferredFrameworks: ["DIRECT_RESPONSE", "VALUE_FIRST", "SOCIAL_PROOF", "CASE_STUDY", "CURIOSITY_HOOK"],
    taskContext: null,
  ...
  "Delivered": {
    ...
    preferredFrameworks: ["EMB_POST_PURCHASE", "SOCIAL_PROOF", "VALUE_FIRST", "CASE_STUDY", "BAB", "CURIOSITY_HOOK"],
    taskContext: null,
