...
const PLAYBOOKS: Record<string, StagePlaybook> = {
  "New Lead": {
    ...
    preferredFrameworks: ["HORMOZI_ACA", "CURIOSITY_HOOK", "CASE_STUDY", "VALUE_FIRST", "PAS"],
    taskContext: null,
  ...
  "Contacted": {
    ...
    preferredFrameworks: ["DIRECT_RESPONSE", "VALUE_FIRST", "CASE_STUDY", "CURIOSITY_HOOK", "HORMOZI_ACA"],
    taskContext: null,
  ...
  "Quote Sent": {
    ...
    preferredFrameworks: ["DIRECT_RESPONSE", "VALUE_FIRST", "BAB", "CASE_STUDY", "CURIOSITY_HOOK"],
    taskContext: null,
  ...
  "Delivered": {
    ...
    preferredFrameworks: ["EMB_POST_PURCHASE", "VALUE_FIRST", "CASE_STUDY", "BAB", "CURIOSITY_HOOK", "PAS"],
    taskContext: null,
